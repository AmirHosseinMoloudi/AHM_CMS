<footer id="footer-outer">
    <div id="footer-inner">
        <div id="footer-inner-left">
            <a href="/policies" class="footer-menu-item" >قوانین</a>
            <a href="/Blog" class="footer-menu-item">وبلاگ</a>
            <a href="/download" class="footer-menu-item" >دانلود</a>
        </div><!--footer-inner-left ends here-->

        <div id="footer-inner-right">
            <a href="https://github.com/AmirHosseinMoloudi/AHM_CMS" target="_blank" aria-label="GitHub">
            ...
            <a href="https://github.com/AmirHosseinMoloudi/AHM_CMS" target="_blank" aria-label="Forum">
                <div class="links-icons">
                    <div class="icon">
...
<div id="footer-copyrights">
    <p>&copy; <?= date('Y') ?> AHM-CMS is a open source project released under the MIT
