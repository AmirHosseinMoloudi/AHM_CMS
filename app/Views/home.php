...
<section id="spotlight-outer">
    <div id="spotlight-inner">
        <div id="spotlight-title" class="animated fadeInDown">AHM-CMS
            <div id="spotlight-version">v1.0</div>
        </div><!--spotlight title ende-->
        <div id="spotlight-note" class="animated fadeInDown">AHM - CMS</div>
        ...
        <div id="spotlight-button-holder" class="animated fadeInDown">
            <a href="/Blog" id="spotlight-link">آخرین مطالب</a>
        </div><!--spotlight-button-ends here-->

        <div id="github-scores" class="animated fadeInDown">
            <a href="https://github.com/AmirHosseinMoloudi/AHM_CMS" class="github-link" target="_blank">
                <div class="githubs">
                    <div class="github-icon">
                      ...
                      <div class="github-data">
                          <span class="boldy700">Github</span>
                      </div>
                    </div>
                </div>
            </a>
...
<section class="content-outer">
    <div class="content-inner">
        ...
        <div class="section-title">ویژگی های کلیدی</div>
        <div class="clr"></div>
        ...
        <div class="why-rows">
            <div class="ci-features-box">
                ...
                <div class="ci-features-box-text-area">
                    <div class="ci-features-box-title">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</div>
                    <div class="clr"></div>
    ...
    <div id="important-links-inner">
        <a href="/download" class="important-link">
            <div class="important-link-boxes">
                <span class="boldy600 dark">دانلود</span>
                <br />
                دانلود
                <br /><br />
        ...
        <a href="https://github.com/AmirHosseinMoloudi/AHM_CMS" class="important-link">
            <div class="important-link-boxes">
                <span class="boldy600 dark">مستندات</span>
                <br />
                مستندات
                <br /><br />
        ...
        <a href="https://github.com/AmirHosseinMoloudi/AHM_CMS" class="important-link" target="_blank">
            <div class="important-link-boxes">
                <span class="boldy600 dark">گفتگو</span>
                <br />
                گفتگو
                <br /><br />
        ...
        <a href="https://github.com/AmirHosseinMoloudi/AHM_CMS" class="important-link" target="_blank">
            <div class="important-link-boxes">
                <span class="boldy600 dark">گیت هاب</span>
                <br />
                گیت هاب
                <br /><br />
...
<section class="content-outer">
    <div class="content-inner">
        ...
        <div class="flex-container">
            <div class="recent-Blog-and-forum-posts">
                <div class="rnafp-name">آخرین مطالب وبلاگ</div>
                <div class="clr"></div>

                <?= view_cell('\App\Libraries\Blog::recentPostsWidget', 'limit=5, view=blog/_home_widget') ?>
            </div><!--recent-Blog-and-forum-posts here-->
